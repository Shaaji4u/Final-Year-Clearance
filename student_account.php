...
if($msg !=""){
	...
	$msg =$msg1 ."<ol>".$msg."</ol>";
	$msg = $msg."<p>Endeavour to meet the Head of the above Department or clearance section to tender your complaints for further analysis and clearance !</p>";
...
if($msg2 !=""){
	$msg1 = "<p> Your Clearance Application has been Approved (Cleared) by the following Departments / Clearance Section </p>";

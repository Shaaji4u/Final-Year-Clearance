<div  class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<img src="settings/images/headlog.jpg"  class="img-responsive" ></img>
			</div>
		...
		<div class="col-xs-12 col-sm-12">
			...
			<div id="navbarCollapse" class="collapse navbar-collapse navedit">
				<ul class="nav navbar-nav" >  
					<li class="active"><a href="generate_pin.php">Generate application ID</a></li>
					<li><a href="login_to_profile.php">Complete Application</a></li> 
					<li ><a href="login_status.php">Check Application Status</a></li>
